...
import com.mirandnyan.mired.content.blocks.food_replicator.FoodReplicatorBlock;
import com.mirandnyan.mired.content.blocks.food_replicator.FoodReplicatorBlockEntity;
...
public class CVABlocks {
    ...
    protected static <T extends Block> ModelFile getExisting(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov) {
        return prov.models().getExistingFile(CreateVariousAdditions.asResource("block/" + ctx.getName() + "/block"));
    }

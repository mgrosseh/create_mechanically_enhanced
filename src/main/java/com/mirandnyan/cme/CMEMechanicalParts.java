...
public class CMEMechanicalParts {
    ...
    // TODO: the transforms are a little wonky rn, should go though and match the definitions better
    // -> should make helper that translates a rotation and translation pair into an AffineTransform, that way it is less confusing to use
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> WOODEN_GRIP = new MechanicalPartBuilder("wooden_grip")
            ...
            .origin(AffineTransform.identity.translate(0, -0.5, 2), MechanicalToolSlot.ROOT)
            .slot(AffineTransform.identity.rotateXDegrees(-90f).translate(8f, -6f, 8f), MechanicalToolSlot.COG_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> CARDBOARD_COG = new MechanicalPartBuilder("cardboard_cog")
            ...
            .origin(AffineTransform.identity.translate(8f, 4f, 9f).rotateXDegrees(90f), MechanicalToolSlot.COG_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(90f).translate(8f, -8f, 12f), MechanicalToolSlot.ACCELERATOR_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> SIMPLE_ANDESITE_ACCELERATOR = new MechanicalPartBuilder("simple_andesite_accelerator")
            .material(CMEMaterials.ANDESITE)
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 0f, 8f), MechanicalToolSlot.ACCELERATOR_SLOT)
            .slot(AffineTransform.identity.translate(8f, 1f, 8f).rotateXDegrees(180f), MechanicalToolSlot.GEARBOX_SLOT)
            // TODO: tip
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> STONE_ACCELERATOR = new MechanicalPartBuilder("stone_accelerator")
            ...
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 0f, 8f), MechanicalToolSlot.ACCELERATOR_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 0f, 8f), MechanicalToolSlot.GEARBOX_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> CARDBOARD_CASING_ACCELERATOR = new MechanicalPartBuilder("cardboard_casing_accelerator")
            .material(CMEMaterials.CARDBOARD)
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 0f, 8f), MechanicalToolSlot.ACCELERATOR_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(180f).translate(8f, -1f, 8f), MechanicalToolSlot.GEARBOX_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> NETHER_STAR_ACCELERATOR = new MechanicalPartBuilder("nether_star_accelerator")
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 0.25f, 8f), MechanicalToolSlot.ACCELERATOR_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(180f).translate(8f, -0.25f, 8f), MechanicalToolSlot.GEARBOX_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> CARDBOARD_GEARBOX = new MechanicalPartBuilder("cardboard_gearbox")
            .material(CMEMaterials.CARDBOARD)
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 1f, 8f), MechanicalToolSlot.GEARBOX_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(90).translate(8f, 3f + 8, 11f), MechanicalToolSlot.AUTOMATON_SLOT)
            .slot(AffineTransform.identity.rotateXDegrees(-90f).translate(8f, 11f, 5f), MechanicalToolSlot.TANK_SLOT)
            .slot(AffineTransform.identity.translate(8f, 7f, 8f), MechanicalToolSlot.TIP_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> CARDBOARD_TANK = new MechanicalPartBuilder("cardboard_tank")
            .material(CMEMaterials.CARDBOARD)
            .origin(AffineTransform.identity.rotateXDegrees(180f).translate(8f, 8f, 8f), MechanicalToolSlot.TANK_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> CARDBOARD_DRILL_HEAD = new MechanicalPartBuilder("cardboard_drill_head")
            .material(CMEMaterials.CARDBOARD)
            .origin(AffineTransform.identity.translate(8f, 0f, 8f), MechanicalToolSlot.TIP_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> BLAZE_AUTOMATON = new MechanicalPartBuilder("blaze_automaton")
            .origin(AffineTransform.identity.translate(8f, 0f, 8f), MechanicalToolSlot.AUTOMATON_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> BLASTING_REFINER = new MechanicalPartBuilder("blasting_refiner")
            ...
            .origin(AffineTransform.identity.translate(8f, 0f, 8f), MechanicalToolSlot.TIP_SLOT) // TODO: type tag system then use REFINER SLOT
            .slot(AffineTransform.identity.translate(8f, 1f, 8f), MechanicalToolSlot.TIP_SLOT)
    ...
    public static final RegistryEntry<MechanicalPart, MechanicalPart> SILK_BRUSH_REFINER = new MechanicalPartBuilder("silk_brush_refiner")
            ...
            .subpart(SILK_BRUSH_REFINER_SUBPART.withOrigin(
                    angle -> AffineTransform.identity
                            .translateBack(2, 2, 8)
